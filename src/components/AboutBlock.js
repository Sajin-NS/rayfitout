export default function AboutBlock() {
  return (
    <section className="bg-white py-global_y px-6 md:px-global_x text-center  border-b border-gray-300">
      <div className="max-w-9xl mx-auto">
        <p className="text-onWhiteGray text-small font-mont font-extralight text-justify">
